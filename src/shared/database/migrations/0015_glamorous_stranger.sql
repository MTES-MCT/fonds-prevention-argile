CREATE TABLE "catastrophes_naturelles" (
	"code_national_catnat" text PRIMARY KEY NOT NULL,
...
CREATE INDEX "catastrophes_naturelles_libelle_risque_idx" ON "catastrophes_naturelles" USING btree ("libelle_risque_jo");