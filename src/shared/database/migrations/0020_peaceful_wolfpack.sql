...
ALTER TABLE "parcours_prevention" ADD COLUMN "rga_simulation_data_agent" jsonb;--> statement-breakpoint
ALTER TABLE "parcours_prevention" ADD COLUMN "rga_simulation_agent_edited_at" timestamp;--> statement-breakpoint
ALTER TABLE "parcours_prevention" ADD COLUMN "rga_simulation_agent_edited_by" uuid;--> statement-breakpoint
