  ...
  return (
    <>
        ...
        <div className="fr-container">
          <div className="fr-footer__body">
            <div className="fr-footer__brand fr-enlarge-link">
              <Link
                href="/"
                title="Accueil - Fonds prévention argile - Ministère<br>de la transition<br>écologique"
              >
                <p className="fr-logo">
                  Ministère
                  <br />
            ...
            <div className="fr-footer__content">
              <div className="fr-footer__content-desc [&_a]:after:content-none!">
                Fonds prévention argile est une plateforme numérique conçue par
                la{" "}
                <a
                ...
                . Le Fonds de Prévention Argile est en phase d'expérimentation,
                n'hésitez pas à nous faire part de vos retours par mail à
      ...
      <dialog
        id="footer-display"
        className="fr-modal"
        aria-labelledby="footer-display-title"
      >
