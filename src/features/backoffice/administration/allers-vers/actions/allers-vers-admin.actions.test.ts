...
vi.mock("@/features/backoffice/administration/allers-vers/services/allers-vers-import.service");
...
import { importAllersVersFromExcel } from "@/features/backoffice/administration/allers-vers/services/allers-vers-import.service";
...
describe("allers-vers-admin.actions", () => {
  ...
  describe("importAllersVersAction", () => {
    it("devrait autoriser l'import pour SUPER_ADMINISTRATEUR", async () => {
      ...
      expect(checkBackofficePermission).toHaveBeenCalledWith(BackofficePermission.ALLERS_VERS_IMPORT);
  ...
  describe("updateAllersVersAction", () => {
    ...
    it("devrait autoriser la mise à jour pour SUPER_ADMINISTRATEUR", async () => {
      ...
      expect(checkBackofficePermission).toHaveBeenCalledWith(BackofficePermission.ALLERS_VERS_WRITE);
