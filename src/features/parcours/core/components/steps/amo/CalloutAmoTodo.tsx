            ...
            {!amoRefusee ? (
              <>
                ...
                <p className="fr-callout__text fr-mb-4w">
                  ...
                  Contactez puis confirmez la structure choisie dans les
                  propositions ci-dessous afin de passer à l'étape suivante.
                </p>
              </>
            ) : (
              <>
                ...
                <p className="fr-callout__text fr-mb-4w">
                  ...
                  d'accompagnement. Vous pouvez soumettre une nouvelle demande à
                  un autre AMO. Assurez-vous de le contacter au préalable pour
