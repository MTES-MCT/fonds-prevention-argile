...
export function StepProprietaire({
  ...
  return (
    <SimulateurLayout
      ...
      subtitle="<p>Les résidences secondaires et les maisons en location sont exclues du dispositif.</p><p>Les propriétaires en indivision sont éligibles à l’aide.</p><p>Les SCI, les nus-propriétaires, les usufruitiers et les particuliers en cours d’acquisition d’une maison individuelle ne sont pas éligibles à l’aide.</p>"
