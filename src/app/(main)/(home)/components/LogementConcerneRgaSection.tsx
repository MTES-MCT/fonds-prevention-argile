      ...
      <div className="fr-container">
        <div className="fr-grid-row items-center gap-6 md:gap-0">
          ...
          <div className="fr-col-12 fr-col-md-6">
            <h2 className="text-left">{content.logement_concerne_section.title}</h2>
            ...
            <div className="fr-mt-4v">
              <a href="#qui-peut-beneficier-aides" className=" underline text-sm md:text-base">
          ...
          <div className="fr-col-12 fr-col-md-6 flex justify-center md:justify-end">
            <div className="relative w-full max-w-[484px] aspect-[640/495]">
              <Image
