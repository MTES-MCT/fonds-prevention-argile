...
export default function PourEnSavoirPlusSection() {
  return (
    <section
      id="pour-en-savoir-plus"
      className="fr-container-fluid fr-py-10w bg-[var(--background-alt-grey)] section-anchor">
    ...
    <div className="fr-container">
      ...
      <div className="fr-grid-row fr-grid-row--gutters">
        {content.pour_en_savoir_plus_section.cards.map((card, index) => (
          <div key={`${index}-card`} className="fr-col-12 fr-col-md-6 fr-col-lg-3">
            <div className="fr-card fr-enlarge-link">
              <div className="fr-card__body">
                <div className="fr-card__content">
                  <h3 className="fr-card__title">
                    <Link href={card.linkUrl} target="_blank" rel="noopener noreferrer">
                      {card.title}
                    </Link>
                  </h3>
