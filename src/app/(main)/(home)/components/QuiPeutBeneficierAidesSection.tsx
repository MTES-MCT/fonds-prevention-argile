...
export default function QuiPeutBeneficierAidesSection() {
  return (
    <section id="qui-peut-beneficier-aides" className="fr-container-fluid fr-py-10w">
      <div className="fr-container">
        {/* En-tête avec titre et sous-titre */}
        <div>
          <h2 className="fr-mb-4v">{content.qui_peut_beneficier_aides_section.title}</h2>
          <p className="fr-text--lg">{content.qui_peut_beneficier_aides_section.subtitle}</p>
        </div>
        ...
        <div className="fr-grid-row fr-grid-row--gutters">
          ...
          <div className="fr-col-12 fr-col-md-6">
            <div className="relative h-[500px] lg:h-[600px] xl:h-[700px] w-full">
              <Image
                alt={content.qui_peut_beneficier_aides_section.image.alt}
                className="object-contain object-left"
                fill
                priority
                quality={95}
                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"
                src={content.qui_peut_beneficier_aides_section.image.src}
              />
            </div>
          </div>
          ...
          <div className="fr-col-12 fr-col-md-6 justify-items-center">
            <div className="fr-pl-0 lg:fr-pl-6w flex flex-col justify-center h-full min-h-[500px] lg:min-h-[600px] xl:min-h-[700px]">
              ...
              <div className="fr-mb-6w">
                {content.qui_peut_beneficier_aides_section.text_items.map((item, index) => (
              ...
              {/* CTA */}
              <Link className="fr-btn fr-btn--lg fr-icon-arrow-right-line fr-btn--icon-right" href="/simulateur">
                {content.qui_peut_beneficier_aides_section.cta_label}
              </Link>
            </div>
          </div>
        </div>
