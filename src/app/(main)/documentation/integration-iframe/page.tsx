...
export const metadata: Metadata = {
  ...
  description: "Guide d'intégration de notre simulateur d'éligibilité sur votre site partenaire",
...
></iframe>`;
  ...
  return (
    <div className="fr-container fr-py-6w">
      ...
      <p className="fr-text--lead">Simulateur d'éligibilité au Fonds prévention argile</p>

      {/* Introduction */}
      <div className="fr-callout fr-mt-6w">
        <h2 className="fr-callout__title">Un service public à disposition de vos utilisateurs</h2>
        <p className="fr-callout__text">
          Le Fonds prévention argile est un service public qui aide les propriétaires à prévenir les risques liés au
          retrait-gonflement des argiles. En intégrant notre simulateur d'éligibilité directement sur votre site, vous
          permettez à vos visiteurs de vérifier leurs droits aux aides sans quitter votre plateforme.
        </p>
      </div>
      ...
      <p>
        Voici à quoi ressemble le simulateur intégré sur votre site. Les utilisateurs peuvent remplir le formulaire et,
        s'ils sont éligibles, seront redirigés vers la plateforme officielle pour finaliser leur demande.
      </p>
      ...
      <p>Voici le code à intégrer dans votre HTML ou votre système de gestion de contenu (Wordpress, Drupal, etc.) :</p>
      ...
      <p>
        Vous pouvez personnaliser l'apparence avec des ombres portées, des bordures arrondies et un centrage automatique
        :
      </p>
      <div className="fr-highlight">
        <pre>
      ...
      <div className="fr-alert fr-alert--info fr-mt-4w">
        ...
        <ul>
          ...
          <li>
            ...
            (comportement normal pour les iframes)
          </li>
        </ul>
      </div>
      ...
      <div className="fr-accordions-group">
        <section className="fr-accordion">
          ...
          <div className="fr-collapse" id="accordion-1">
            <ul>
              <li>Identifier la page ou la section où intégrer le simulateur</li>
              <li>Prévoir une hauteur minimale de 800px pour l'affichage optimal</li>
              <li>S'assurer que la largeur disponible est d'au moins 400px (pour mobile)</li>
            </ul>
          </div>
        </section>
        ...
        <section className="fr-accordion">
          ...
          <div className="fr-collapse" id="accordion-2">
            <ul>
              ...
              <li>Coller le code dans votre page HTML ou votre éditeur de contenu</li>
              <li>Adapter les styles CSS selon votre charte graphique si besoin</li>
        ...
        <section className="fr-accordion">
          ...
          <div className="fr-collapse" id="accordion-3">
            <ul>
              <li>Tester la simulation complète depuis votre site en version desktop</li>
              <li>Vérifier l'affichage responsive sur mobile et tablette</li>
              <li>Confirmer que la redirection vers la page de connexion fonctionne</li>
        ...
        <section className="fr-accordion">
          ...
          <div className="fr-collapse" id="accordion-4">
            <ul>
              ...
              <li>Expliquer que le service est fourni par le gouvernement français</li>
              <li>Mentionner la gratuité et l'absence d'engagement du test d'éligibilité</li>
            </ul>
          </div>
        </section>
      </div>
      ...
      <div className="fr-callout fr-callout--brown-caramel">
        ...
        <p className="fr-callout__text">
          Notre équipe est disponible pour vous accompagner dans l'intégration du simulateur sur votre site.
        </p>
        <p>
          <strong>Contact :</strong>{" "}
          <a href="mailto:contact@fonds-prevention-argile.beta.gouv.fr">contact@fonds-prevention-argile.beta.gouv.fr</a>
        </p>
        <p className="fr-text--sm">Délai de réponse moyen : 48 heures ouvrées</p>
      </div>
