...
export default function PoseCanalisationEvacuationEauxPluviales() {
  return (
    <TravauxEligiblesTemplate
      title={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.title
      }
      pageLink={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.pageLink
      }
      tag={contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.tag}
      image={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.image
      }
      une_des_solutions={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.une_des_solutions
      }
      solutions={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.solutions
      }
      ...
      a_retenir={
        contentTravauxEligiblesPoseCanalisationEvacuationEauxPluviales.a_retenir
      }
    />
  );
}
