    ...
    <div>
      ...
      <div className="fr-callout fr-my-4w">
        ...
        <p className="fr-callout__text">
          Cette fonctionnalité est en cours de développement. Vous pourrez bientôt consulter des statistiques sur votre
          activité : nombre de demandes traitées, délais moyens, etc.
        </p>
      </div>
    </div>
  );
