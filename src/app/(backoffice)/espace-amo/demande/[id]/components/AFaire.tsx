      ...
      <div className="fr-card__body">
        <div className="fr-card__content">
          <h3 className="fr-card__title">
            <span className="fr-icon-todo-fill fr-icon--sm fr-mr-2v" aria-hidden="true"></span>À faire
          </h3>
          <div className="fr-card__desc">
            <ul className="fr-raw-list">
              <li className="fr-mb-2v">
                <span className="fr-icon-arrow-right-line fr-icon--sm fr-mr-1v" aria-hidden="true"></span>
