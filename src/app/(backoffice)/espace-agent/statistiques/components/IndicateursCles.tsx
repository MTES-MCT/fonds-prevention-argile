...
import type { AmoIndicateursCles } from "@/features/backoffice/espace-agent/statistiques/domain/types";
...
export function IndicateursCles({ indicateurs }: IndicateursClesProps) {
  return (
    <div className="fr-mb-6w">
      ...
      <p className="fr-text-mention--grey fr-mb-3w">Les données essentielles de votre compte.</p>
