      ...
      <section className="fr-background-alt--blue-france fr-py-4w">
        <div className="fr-container">
          <div className="fr-grid-row fr-grid-row--gutters">
            ...
            <div className="fr-col-12 fr-col-md-8">
              <div className="fr-mb-4w">
                <InfoLogement logement={prospect.infoLogement} adresse={prospect.logement.adresse} editSimulationHref={ROUTES.backoffice.espaceAgent.editionDonneesSimulation(prospect.parcoursId)} />
              </div>
              <div>
                <GagnezDuTemps />
              </div>
