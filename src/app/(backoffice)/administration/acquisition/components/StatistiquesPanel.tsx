      ...
      <section className="fr-container-fluid fr-py-4w bg-(--background-alt-blue-france)">
        <div className="fr-container">
          ...
          <fieldset className="fr-segmented fr-mb-4w">
            <legend className="fr-segmented__legend fr-sr-only">Selection de la vue statistiques</legend>
            ...
            <div>
              ...
              {chartLoaded && visitesTriees.length > 0 && (
                <div className="fr-mt-4w p-12 fr-background-default--grey">
                  <h3 className="fr-h4 fr-mb-2w">Evolution des visites depuis l'ouverture (16/10/2025)</h3>
                  <line-chart
                    key="visites-chart"
                    x={chartData.xData}
                    y={chartData.yData}
          ...
          {activeView === "funnel" && (
            <div>
              <h2 className="fr-h3 fr-mb-3w">Funnel : Completude du simulateur RGA</h2>
