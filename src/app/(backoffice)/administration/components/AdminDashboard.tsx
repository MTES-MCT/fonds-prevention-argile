...
type TabId = "statistiques" | "users" | "agents" | "amo" | "eligibilite" | "diagnostic" | "devis" | "factures";
  ...
  return (
    <>
      ...
      <div className="w-full">
        {/* Conteneur commun : pleine largeur + padding 2rem */}
        <div className="w-full px-32 md:px-16 lg:px-32">
          {/* Panel Statistiques */}
          <div className={activeTab === "statistiques" ? "" : "fr-hidden"} role="region" aria-label="Statistiques">
            <div className="w-full flex justify-center fr-mt-6w">
              <StatistiquesPanel />
            </div>
          </div>
