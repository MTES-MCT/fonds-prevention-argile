  ...
  return (
    <>
        ...
        <div className="fr-container">
          ...
          <p className="fr-text--lg" style={{ color: "var(--text-mention-grey)", marginBottom: 0 }}>
            {canViewUserDetails
              ...
              : "Consultez les statistiques agregees des demandeurs inscrits sur la plateforme."}
          </p>
      ...
      <section className="fr-container-fluid fr-py-4w bg-(--background-alt-blue-france)">
        <div className="fr-container">
          {/* Controle segmente pour choisir les statistiques */}
          {!error && (
          ...
          {/* Statistiques selon la vue selectionnee */}
          {!error && (
            <div className="fr-mb-4w">
              {activeView === "etape" && (
              ...
              {activeView === "amo" && (
                <UsersAmoStats users={filteredUsers} selectedDepartement={selectedDepartement} />
              )}
          ...
          {/* Filtre par departement - Seulement si permission de voir les details */}
          ...
          {/* Liste des utilisateurs ou message vide - Seulement si permission de voir les details */}
          {!error && canViewUserDetails && (
            <>
              {filteredUsers.length === 0 && selectedDepartement ? (
                <div className="fr-callout fr-callout--info">
                  <p className="fr-callout__text">
                    Aucun demandeur trouve pour le departement {selectedDepartement}.
                  </p>
                </div>
              ) : users.length === 0 ? (
                <div className="fr-callout fr-callout--info">
                  <p className="fr-callout__text">Aucun demandeur enregistre pour le moment.</p>
                </div>
              ) : (
