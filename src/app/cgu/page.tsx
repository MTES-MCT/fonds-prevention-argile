  ...
  return (
    <section className="fr-container-fluid fr-py-10w">
      <div className="fr-container [&_h2]:text-[var(--text-title-grey)]! [&_h2]:mt-10!">
        ...
        <p>{contentCguPage.header}

        <h2>{contentCguPage.presentation}</h2>
        {contentCguPage.presentation_paragraphes.map((par, index) => (
          <p>{par}</p>
        ))}
        <ul className="">
          {contentCguPage.presentation_fonctionnalites.map((fonctionnalite, index) => (
        ...
        {contentCguPage.definition_paragraphes.map((par, index) => (
          <p>{par}</p>
        ))}
        ...
        <ul className="">
          {contentCguPage.fonctionnalites_sans_compte_fonctionnalites.map((fonctionnalite, index) => (
            <li key={index} className="">
              {fonctionnalite}
            </li>
          ))}
        ...
        <p>{contentCguPage.Pagefonctionnalites_avec_compte_creation_description}</p>
        <h4>{contentCguPage.fonctionnalites_avec_compte_dossier}</h4>
        <p>{richTextParser(contentCguPage.fonctionnalites_avec_compte_dossier_ds)}<p>
        <p>{contentCguPage.fonctionnalites_avec_compte_dossier_fonctionnalite}</p>
        <ul className="">
          {contentCguPage.fonctionnalites_avec_compte_dossier_fonctionnalite_liste.map((fonctionnalite, index) => (
            <li key={index} className="">
              {fonctionnalite}
            </li>
          ))}
        </ul>
        {contentCguPage.fonctionnalites_avec_compte_dossier_paragraphes.map((par, index) => (
          <p>{par}</p>
        ))}
        ...
        {contentCguPage.engagements_descriptions.map((engagement, index) => (
            <h3>{engagement.title}</h3>
            {engagement.descriptions.map((descr, index) => (
              <p>{descr}</p>
            ))}
          ))}

        <h2>{contentCguPage.evolutions}</h2>
        {contentCguPage.evolutions_descriptions.map((par, index) => (
          <p>{par}</p>
        ))}
