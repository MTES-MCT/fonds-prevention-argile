...
| Départements non couverts (ADR-0033)            | `administration/demandeurs/actions/couverture-territoriale.actions.ts` | aggregate   | sans `USERS_READ` → DENY, sans requête base                                                                                                                                    | OUI (testé) |
