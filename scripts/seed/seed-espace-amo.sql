...
-- ID de l'entreprise AMO utilisé : XXXXXX
...
VALUES
  ...
  ('33333333-3333-3333-3333-333333333301', '22222222-2222-2222-2222-222222222201', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Marie', 'Dupont', 'marie.dupont@test.fr', '06 12 34 56 78', '12 rue de la République, 36000 Châteauroux', NULL, NOW() - INTERVAL '28 days', NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days', NOW()),
  ('33333333-3333-3333-3333-333333333302', '22222222-2222-2222-2222-222222222202', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Jean', 'Martin', 'jean.martin@test.fr', '06 23 45 67 89', '45 avenue de la Gare, 36000 Châteauroux', NULL, NOW() - INTERVAL '23 days', NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days', NOW()),
  ('33333333-3333-3333-3333-333333333303', '22222222-2222-2222-2222-222222222203', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Sophie', 'Bernard', 'sophie.bernard@test.fr', '06 34 56 78 90', '8 rue du Château, 36000 Châteauroux', NULL, NOW() - INTERVAL '18 days', NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days', NOW()),
  ('33333333-3333-3333-3333-333333333304', '22222222-2222-2222-2222-222222222204', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Pierre', 'Durand', 'pierre.durand@test.fr', '06 45 67 89 01', '5 avenue Jean Jaurès, 36100 Issoudun', NULL, NOW() - INTERVAL '20 days', NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days', NOW()),
  ('33333333-3333-3333-3333-333333333305', '22222222-2222-2222-2222-222222222205', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Claire', 'Moreau', 'claire.moreau@test.fr', '06 56 78 90 12', '18 rue de la Liberté, 36100 Issoudun', NULL, NOW() - INTERVAL '16 days', NOW() - INTERVAL '18 days', NOW() - INTERVAL '18 days', NOW()),
  ('33333333-3333-3333-3333-333333333306', '22222222-2222-2222-2222-222222222206', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Lucas', 'Petit', 'lucas.petit@test.fr', '06 67 89 01 23', '8 place de la Mairie, 36300 Le Blanc', NULL, NOW() - INTERVAL '53 days', NOW() - INTERVAL '55 days', NOW() - INTERVAL '55 days', NOW()),
  ('33333333-3333-3333-3333-333333333307', '22222222-2222-2222-2222-222222222207', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Emma', 'Robert', 'emma.robert@test.fr', '06 78 90 12 34', '22 rue du Moulin, 36200 Argenton-sur-Creuse', NULL, NOW() - INTERVAL '33 days', NOW() - INTERVAL '35 days', NOW() - INTERVAL '35 days', NOW()),
  ('33333333-3333-3333-3333-333333333308', '22222222-2222-2222-2222-222222222208', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Hugo', 'Richard', 'hugo.richard@test.fr', '06 89 01 23 45', '3 boulevard George Sand, 36400 La Châtre', NULL, NOW() - INTERVAL '68 days', NOW() - INTERVAL '70 days', NOW() - INTERVAL '70 days', NOW()),
  ('33333333-3333-3333-3333-333333333309', '22222222-2222-2222-2222-222222222209', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Alice', 'Leroy', 'alice.leroy@test.fr', '06 90 12 34 56', '15 rue de l''Abbaye, 36130 Déols', NULL, NOW() - INTERVAL '15 days', NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days', NOW()),
  ('33333333-3333-3333-3333-333333333310', '22222222-2222-2222-2222-222222222210', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Thomas', 'Garcia', 'thomas.garcia@test.fr', '06 01 23 45 67', '7 rue du Commerce, 36500 Buzançais', NULL, NOW() - INTERVAL '22 days', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  ('33333333-3333-3333-3333-333333333311', '22222222-2222-2222-2222-222222222211', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Léa', 'Martinez', 'lea.martinez@test.fr', '06 11 22 33 44', '1 place de la Collégiale, 36110 Levroux', NULL, NOW() - INTERVAL '24 days', NOW() - INTERVAL '26 days', NOW() - INTERVAL '26 days', NOW()),
  ('33333333-3333-3333-3333-333333333312', '22222222-2222-2222-2222-222222222212', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Nathan', 'Lopez', 'nathan.lopez@test.fr', '06 22 33 44 55', '4 rue du Château, 36600 Valençay', NULL, NOW() - INTERVAL '48 days', NOW() - INTERVAL '50 days', NOW() - INTERVAL '50 days', NOW()),
  -- Dossiers supplémentaires LOGEMENT_ELIGIBLE
  ('33333333-3333-3333-3333-333333333331', '22222222-2222-2222-2222-222222222231', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Amélie', 'Simon', 'amelie.simon@test.fr', '06 33 44 55 66', '22 boulevard de Cluis, 36000 Châteauroux', NULL, NOW() - INTERVAL '58 days', NOW() - INTERVAL '60 days', NOW() - INTERVAL '60 days', NOW()),
  ('33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222233', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Marine', 'Michel', 'marine.michel@test.fr', '06 44 55 66 77', '33 place du Marché, 36100 Issoudun', NULL, NOW() - INTERVAL '43 days', NOW() - INTERVAL '45 days', NOW() - INTERVAL '45 days', NOW()),
  ('33333333-3333-3333-3333-333333333335', '22222222-2222-2222-2222-222222222235', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Élise', 'Roux', 'elise.roux@test.fr', '06 55 66 77 88', '25 rue du Commerce, 36300 Le Blanc', NULL, NOW() - INTERVAL '13 days', NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days', NOW()),
  ('33333333-3333-3333-3333-333333333336', '22222222-2222-2222-2222-222222222236', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Mathieu', 'David', 'mathieu.david@test.fr', '06 66 77 88 99', '4 impasse du Moulin, 36300 Le Blanc', NULL, NOW() - INTERVAL '8 days', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days', NOW()),
  ('33333333-3333-3333-3333-333333333337', '22222222-2222-2222-2222-222222222237', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Caroline', 'Bertrand', 'caroline.bertrand@test.fr', '06 77 88 99 00', '11 avenue de la Gare, 36200 Argenton-sur-Creuse', NULL, NOW() - INTERVAL '26 days', NOW() - INTERVAL '28 days', NOW() - INTERVAL '28 days', NOW()),
  ('33333333-3333-3333-3333-333333333339', '22222222-2222-2222-2222-222222222239', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Élodie', 'Fournier', 'elodie.fournier@test.fr', '06 88 99 00 11', '17 rue Nationale, 36400 La Châtre', NULL, NOW() - INTERVAL '10 days', NOW() - INTERVAL '12 days', NOW() - INTERVAL '12 days', NOW()),
  ('33333333-3333-3333-3333-333333333340', '22222222-2222-2222-2222-222222222240', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_eligible', 'Guillaume', 'Girard', 'guillaume.girard@test.fr', '06 99 00 11 22', '28 avenue Marcel Dassault, 36130 Déols', NULL, NOW() - INTERVAL '30 days', NOW() - INTERVAL '32 days', NOW() - INTERVAL '32 days', NOW()),

  -- ===== EN_ATTENTE (8 demandes en attente) =====
  ('33333333-3333-3333-3333-333333333313', '22222222-2222-2222-2222-222222222213', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Camille', 'Roux', 'camille.roux@test.fr', '06 10 20 30 40', '18 rue des Lilas, 36000 Saint-Marcel', NULL, NULL, NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days', NOW()),
  ('33333333-3333-3333-3333-333333333314', '22222222-2222-2222-2222-222222222214', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Antoine', 'Fournier', 'antoine.fournier@test.fr', '06 20 30 40 50', '25 avenue de la Liberté, 36120 Ardentes', NULL, NULL, NOW() - INTERVAL '8 days', NOW() - INTERVAL '8 days', NOW()),
  ('33333333-3333-3333-3333-333333333315', '22222222-2222-2222-2222-222222222215', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Julie', 'Morel', 'julie.morel@test.fr', '06 30 40 50 60', '3 impasse du Clos, 36110 Montierchaume', NULL, NULL, NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days', NOW()),
  ('33333333-3333-3333-3333-333333333316', '22222222-2222-2222-2222-222222222216', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Maxime', 'Girard', 'maxime.girard@test.fr', '06 40 50 60 70', '9 chemin des Vignes, 36360 Luçay-le-Mâle', NULL, NULL, NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', NOW()),
  ('33333333-3333-3333-3333-333333333317', '22222222-2222-2222-2222-222222222217', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Laura', 'Bonnet', 'laura.bonnet@test.fr', '06 50 60 70 80', '14 rue du Château, 36240 Écueillé', NULL, NULL, NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW()),
  ('33333333-3333-3333-3333-333333333318', '22222222-2222-2222-2222-222222222218', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Romain', 'Lambert', 'romain.lambert@test.fr', '06 60 70 80 90', '42 rue de Belle Isle, 36000 Châteauroux', NULL, NULL, NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NOW()),
  ('33333333-3333-3333-3333-333333333319', '22222222-2222-2222-2222-222222222219', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Chloé', 'Fontaine', 'chloe.fontaine@test.fr', '06 70 80 90 01', '56 rue Ledru-Rollin, 36100 Issoudun', NULL, NULL, NOW() - INTERVAL '12 hours', NOW() - INTERVAL '12 hours', NOW()),
  ('33333333-3333-3333-3333-333333333320', '22222222-2222-2222-2222-222222222220', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Florian', 'Rousseau', 'florian.rousseau@test.fr', '06 80 90 01 12', '12 avenue Gambetta, 36300 Le Blanc', NULL, NULL, NOW() - INTERVAL '6 hours', NOW() - INTERVAL '6 hours', NOW()),
  -- Demandes en attente supplémentaires
  ('33333333-3333-3333-3333-333333333332', '22222222-2222-2222-2222-222222222232', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Baptiste', 'Laurent', 'baptiste.laurent@test.fr', '06 91 02 13 24', '15 impasse des Roses, 36000 Châteauroux', NULL, NULL, NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW()),
  ('33333333-3333-3333-3333-333333333334', '22222222-2222-2222-2222-222222222234', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Adrien', 'Lefèvre', 'adrien.lefevre@test.fr', '06 02 13 24 35', '7 rue des Acacias, 36100 Issoudun', NULL, NULL, NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', NOW()),
  ('33333333-3333-3333-3333-333333333338', '22222222-2222-2222-2222-222222222238', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'en_attente', 'Jérémy', 'Morel', 'jeremy.morel@test.fr', '06 13 24 35 46', '6 rue des Tilleuls, 36200 Argenton-sur-Creuse', NULL, NULL, NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days', NOW()),

  -- ===== LOGEMENT_NON_ELIGIBLE (6 demandes refusées) =====
  ('33333333-3333-3333-3333-333333333321', '22222222-2222-2222-2222-222222222221', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Pauline', 'Mercier', 'pauline.mercier@test.fr', '06 24 35 46 57', '10 rue de la Loire, 36210 Chabris', 'Logement construit après 2000, non éligible au dispositif', NOW() - INTERVAL '28 days', NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days', NOW()),
  ('33333333-3333-3333-3333-333333333322', '22222222-2222-2222-2222-222222222222', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Kévin', 'Blanc', 'kevin.blanc@test.fr', '06 35 46 57 68', '6 place du Marché, 36150 Vatan', 'Demandeur non propriétaire occupant', NOW() - INTERVAL '38 days', NOW() - INTERVAL '40 days', NOW() - INTERVAL '40 days', NOW()),
  ('33333333-3333-3333-3333-333333333323', '22222222-2222-2222-2222-222222222223', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Manon', 'Guérin', 'manon.guerin@test.fr', '06 46 57 68 79', '2 avenue de la Gare, 36260 Reuilly', 'Appartement en étage, non concerné par le RGA', NOW() - INTERVAL '43 days', NOW() - INTERVAL '45 days', NOW() - INTERVAL '45 days', NOW()),
  ('33333333-3333-3333-3333-333333333324', '22222222-2222-2222-2222-222222222224', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Valentin', 'Faure', 'valentin.faure@test.fr', '06 57 68 79 80', '8 rue des Remparts, 36700 Châtillon-sur-Indre', 'Commune non éligible au dispositif', NOW() - INTERVAL '23 days', NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days', NOW()),
  ('33333333-3333-3333-3333-333333333325', '22222222-2222-2222-2222-222222222225', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Océane', 'André', 'oceane.andre@test.fr', '06 68 79 80 91', '100 avenue de Verdun, 36000 Châteauroux', 'Appartement, seules les maisons individuelles sont éligibles', NOW() - INTERVAL '33 days', NOW() - INTERVAL '35 days', NOW() - INTERVAL '35 days', NOW()),
  ('33333333-3333-3333-3333-333333333326', '22222222-2222-2222-2222-222222222226', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'logement_non_eligible', 'Alexandre', 'Lefebvre', 'alexandre.lefebvre@test.fr', '06 79 80 91 02', '78 boulevard Stalingrad, 36100 Issoudun', 'Demandeur non propriétaire occupant du logement', NOW() - INTERVAL '26 days', NOW() - INTERVAL '28 days', NOW() - INTERVAL '28 days', NOW()),

  -- ===== ACCOMPAGNEMENT_REFUSE (4 demandes refusées par l'AMO) =====
  ('33333333-3333-3333-3333-333333333327', '22222222-2222-2222-2222-222222222227', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'accompagnement_refuse', 'Sarah', 'Lemoine', 'sarah.lemoine@test.fr', '06 80 91 02 13', '35 rue Grande, 36200 Argenton-sur-Creuse', 'Zone d''intervention trop éloignée de notre périmètre habituel', NOW() - INTERVAL '48 days', NOW() - INTERVAL '50 days', NOW() - INTERVAL '50 days', NOW()),
  ('33333333-3333-3333-3333-333333333328', '22222222-2222-2222-2222-222222222228', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'accompagnement_refuse', 'Quentin', 'Chevalier', 'quentin.chevalier@test.fr', '06 91 02 13 24', '21 rue de la Promenade, 36400 La Châtre', 'Charge de travail actuelle ne nous permet pas de prendre de nouveaux dossiers', NOW() - INTERVAL '40 days', NOW() - INTERVAL '42 days', NOW() - INTERVAL '42 days', NOW()),
  ('33333333-3333-3333-3333-333333333329', '22222222-2222-2222-2222-222222222229', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'accompagnement_refuse', 'Justine', 'Gautier', 'justine.gautier@test.fr', '06 02 13 24 35', '50 rue Victor Hugo, 36300 Le Blanc', 'Conflit d''intérêt avec un autre projet en cours sur ce secteur', NOW() - INTERVAL '30 days', NOW() - INTERVAL '32 days', NOW() - INTERVAL '32 days', NOW()),
  ('33333333-3333-3333-3333-333333333330', '22222222-2222-2222-2222-222222222230', '26a86d26-1d33-488a-86c1-3cb0b5dc3265', 'accompagnement_refuse', 'Nicolas', 'Muller', 'nicolas.muller@test.fr', '06 13 24 35 46', '15 rue de la Fontaine, 36500 Buzançais', 'Impossibilité de répondre aux contraintes de délai du demandeur', NOW() - INTERVAL '36 days', NOW() - INTERVAL '38 days', NOW() - INTERVAL '38 days', NOW())
ON CONFLICT (id) DO NOTHING;
