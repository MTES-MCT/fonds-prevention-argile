...
INSERT INTO entreprises_amo (id, nom, siret, departements, emails, telephone, adresse) VALUES ('99999999-9999-4999-8999-999999999901'::uuid, 'AMO du Berry Profond (seed test)', '99999999900001', 'Indre 36', 'geraldine@amo-berry.fr', '02 54 00 00 00', '42 rue de la Châtaigne, 36000 Châteauroux') ON CONFLICT (siret) DO UPDATE SET nom = EXCLUDED.nom, departements = EXCLUDED.departements, emails = EXCLUDED.emails, telephone = EXCLUDED.telephone, adresse = EXCLUDED.adresse, updated_at = now();
...
INSERT INTO entreprises_amo (id, nom, siret, departements, emails, telephone, adresse) VALUES ('99999999-9999-4999-8999-999999999903'::uuid, 'AMO Tarn-et-Garonne (seed test)', '99999999900003', 'Tarn-et-Garonne 82', 'amo82@test.fr', '05 63 00 00 00', '1 rue de Montauban, 82000 Montauban') ON CONFLICT (siret) DO UPDATE SET nom = EXCLUDED.nom, departements = EXCLUDED.departements, emails = EXCLUDED.emails, telephone = EXCLUDED.telephone, adresse = EXCLUDED.adresse, updated_at = now();
...
INSERT INTO entreprises_amo (id, nom, siret, departements, emails, telephone, adresse) VALUES ('99999999-9999-4999-8999-999999999902'::uuid, 'Soliha 54 (seed test)', '99999999900002', 'Meurthe-et-Moselle 54', 'soliha54@test.fr', '03 83 00 00 00', '1 rue de Nancy, 54000 Nancy') ON CONFLICT (siret) DO UPDATE SET nom = EXCLUDED.nom, departements = EXCLUDED.departements, emails = EXCLUDED.emails, telephone = EXCLUDED.telephone, adresse = EXCLUDED.adresse, updated_at = now();
