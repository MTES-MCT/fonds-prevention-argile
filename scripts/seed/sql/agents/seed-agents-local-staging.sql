...
INSERT INTO agents (sub, email, given_name, usual_name, role, entreprise_amo_id, allers_vers_id) VALUES ('seed_geraldine', 'geraldine.moulin@amo-berry.fr', 'Géraldine', 'Moulin', 'amo'::agent_role, '99999999-9999-4999-8999-999999999901'::uuid, NULL::uuid) ON CONFLICT (email) DO UPDATE SET role = EXCLUDED.role, entreprise_amo_id = EXCLUDED.entreprise_amo_id, allers_vers_id = EXCLUDED.allers_vers_id, given_name = EXCLUDED.given_name, usual_name = EXCLUDED.usual_name;
INSERT INTO agents (sub, email, given_name, usual_name, role, entreprise_amo_id, allers_vers_id) VALUES ('seed_jeanpatrick', 'jeanpatrick.duval@allers-vers-indre.fr', 'Jean-Patrick', 'Duval', 'allers_vers'::agent_role, NULL::uuid, '17628a5e-6a45-4a3c-a72c-606332b42e4c'::uuid) ON CONFLICT (email) DO UPDATE SET role = EXCLUDED.role, entreprise_amo_id = EXCLUDED.entreprise_amo_id, allers_vers_id = EXCLUDED.allers_vers_id, given_name = EXCLUDED.given_name, usual_name = EXCLUDED.usual_name;
...
INSERT INTO agents (sub, email, given_name, usual_name, role, entreprise_amo_id, allers_vers_id) VALUES ('seed_user14', 'user14@yopmail.com', 'Testeur', 'AMO', 'amo'::agent_role, '5833143c-9397-4a80-a7fc-3c5eb37c7a28'::uuid, NULL::uuid) ON CONFLICT (email) DO UPDATE SET role = EXCLUDED.role, entreprise_amo_id = EXCLUDED.entreprise_amo_id, allers_vers_id = EXCLUDED.allers_vers_id, given_name = EXCLUDED.given_name, usual_name = EXCLUDED.usual_name;
...
INSERT INTO agents (sub, email, given_name, usual_name, role, entreprise_amo_id, allers_vers_id) VALUES ('72bc2109-4dff-40e3-b544-51388e58165b', 'contact@gllm.design', 'Guillaume', 'Bertrand Design', 'amo_et_allers_vers'::agent_role, '5833143c-9397-4a80-a7fc-3c5eb37c7a28'::uuid, '17628a5e-6a45-4a3c-a72c-606332b42e4c'::uuid) ON CONFLICT (email) DO UPDATE SET role = EXCLUDED.role, entreprise_amo_id = EXCLUDED.entreprise_amo_id, allers_vers_id = EXCLUDED.allers_vers_id, given_name = EXCLUDED.given_name, usual_name = EXCLUDED.usual_name;
INSERT INTO agents (sub, email, given_name, usual_name, role, entreprise_amo_id, allers_vers_id) VALUES ('607acb0e-605b-453e-a74a-e029ae7507a9', 'martin@evlaa.com', 'Angela', 'Letellier- Aller-vers', 'amo_et_allers_vers'::agent_role, '99999999-9999-4999-8999-999999999901'::uuid, '17628a5e-6a45-4a3c-a72c-606332b42e4c'::uuid) ON CONFLICT (email) DO UPDATE SET role = EXCLUDED.role, entreprise_amo_id = EXCLUDED.entreprise_amo_id, allers_vers_id = EXCLUDED.allers_vers_id, given_name = EXCLUDED.given_name, usual_name = EXCLUDED.usual_name;
