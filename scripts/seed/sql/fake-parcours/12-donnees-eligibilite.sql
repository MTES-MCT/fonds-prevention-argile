...
VALUES
  -- Allier (03)
  ('11111111-1111-4111-8111-111111111c01', 'sub_elig_01', 'elig01@test.fr', 'Lucas',    'Martin',    'elig01@test.fr', NOW() - INTERVAL '15 days', NOW()),
  ('11111111-1111-4111-8111-111111111c02', 'sub_elig_02', 'elig02@test.fr', 'Emma',     'Bernard',   'elig02@test.fr', NOW() - INTERVAL '15 days', NOW()),
  ('11111111-1111-4111-8111-111111111c03', 'sub_elig_03', 'elig03@test.fr', 'Hugo',     'Petit',     'elig03@test.fr', NOW() - INTERVAL '15 days', NOW()),
  ('11111111-1111-4111-8111-111111111c04', 'sub_elig_04', 'elig04@test.fr', 'Chloe',    'Robert',    'elig04@test.fr', NOW() - INTERVAL '15 days', NOW()),
  -- Indre (36)
  ('11111111-1111-4111-8111-111111111c05', 'sub_elig_05', 'elig05@test.fr', 'Louis',    'Richard',   'elig05@test.fr', NOW() - INTERVAL '10 days', NOW()),
  ('11111111-1111-4111-8111-111111111c06', 'sub_elig_06', 'elig06@test.fr', 'Lea',      'Durand',    'elig06@test.fr', NOW() - INTERVAL '10 days', NOW()),
  ('11111111-1111-4111-8111-111111111c07', 'sub_elig_07', 'elig07@test.fr', 'Nathan',   'Moreau',    'elig07@test.fr', NOW() - INTERVAL '10 days', NOW()),
  -- Dordogne (24)
  ('11111111-1111-4111-8111-111111111c08', 'sub_elig_08', 'elig08@test.fr', 'Manon',    'Simon',     'elig08@test.fr', NOW() - INTERVAL '12 days', NOW()),
  ('11111111-1111-4111-8111-111111111c09', 'sub_elig_09', 'elig09@test.fr', 'Jules',    'Laurent',   'elig09@test.fr', NOW() - INTERVAL '12 days', NOW()),
  ('11111111-1111-4111-8111-111111111c10', 'sub_elig_10', 'elig10@test.fr', 'Camille',  'Lefebvre',  'elig10@test.fr', NOW() - INTERVAL '12 days', NOW()),
  -- Gers (32)
  ('11111111-1111-4111-8111-111111111c11', 'sub_elig_11', 'elig11@test.fr', 'Tom',      'Leroy',     'elig11@test.fr', NOW() - INTERVAL '8 days',  NOW()),
  ('11111111-1111-4111-8111-111111111c12', 'sub_elig_12', 'elig12@test.fr', 'Jade',     'Roux',      'elig12@test.fr', NOW() - INTERVAL '8 days',  NOW()),
  -- Nord (59) - non éligible département
  ('11111111-1111-4111-8111-111111111c13', 'sub_elig_13', 'elig13@test.fr', 'Gabriel',  'David',     'elig13@test.fr', NOW() - INTERVAL '5 days',  NOW()),
  ('11111111-1111-4111-8111-111111111c14', 'sub_elig_14', 'elig14@test.fr', 'Alice',    'Bertrand',  'elig14@test.fr', NOW() - INTERVAL '5 days',  NOW()),
  -- Période précédente (40-50j ago) pour les variations
  ('11111111-1111-4111-8111-111111111c15', 'sub_elig_15', 'elig15@test.fr', 'Raphael',  'Morel',     'elig15@test.fr', NOW() - INTERVAL '45 days', NOW()),
  ('11111111-1111-4111-8111-111111111c16', 'sub_elig_16', 'elig16@test.fr', 'Ines',     'Fournier',  'elig16@test.fr', NOW() - INTERVAL '45 days', NOW()),
  ('11111111-1111-4111-8111-111111111c17', 'sub_elig_17', 'elig17@test.fr', 'Adam',     'Girard',    'elig17@test.fr', NOW() - INTERVAL '42 days', NOW()),
  ('11111111-1111-4111-8111-111111111c18', 'sub_elig_18', 'elig18@test.fr', 'Lina',     'Andre',     'elig18@test.fr', NOW() - INTERVAL '42 days', NOW()),
  -- Revenus élevés
  ('11111111-1111-4111-8111-111111111c19', 'sub_elig_19', 'elig19@test.fr', 'Arthur',   'Mercier',   'elig19@test.fr', NOW() - INTERVAL '7 days',  NOW()),
  ('11111111-1111-4111-8111-111111111c20', 'sub_elig_20', 'elig20@test.fr', 'Louise',   'Dupont',    'elig20@test.fr', NOW() - INTERVAL '7 days',  NOW())
...
VALUES ('22222222-2222-4222-8222-222222222c01', '11111111-1111-4111-8111-111111111c01', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c02', '11111111-1111-4111-8111-111111111c02', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c03', '11111111-1111-4111-8111-111111111c03', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c04', '11111111-1111-4111-8111-111111111c04', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c05', '11111111-1111-4111-8111-111111111c05', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c06', '11111111-1111-4111-8111-111111111c06', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c07', '11111111-1111-4111-8111-111111111c07', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c08', '11111111-1111-4111-8111-111111111c08', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c09', '11111111-1111-4111-8111-111111111c09', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c10', '11111111-1111-4111-8111-111111111c10', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c11', '11111111-1111-4111-8111-111111111c11', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c12', '11111111-1111-4111-8111-111111111c12', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c13', '11111111-1111-4111-8111-111111111c13', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c14', '11111111-1111-4111-8111-111111111c14', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c15', '11111111-1111-4111-8111-111111111c15', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c16', '11111111-1111-4111-8111-111111111c16', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c17', '11111111-1111-4111-8111-111111111c17', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c18', '11111111-1111-4111-8111-111111111c18', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c19', '11111111-1111-4111-8111-111111111c19', 'eligibilite', 'todo',
...
INSERT INTO parcours_prevention (id, user_id, current_step, current_status, rga_simulation_data, created_at, updated_at)
VALUES ('22222222-2222-4222-8222-222222222c20', '11111111-1111-4111-8111-111111111c20', 'eligibilite', 'todo',
