...
VALUES
  ('77777777-7777-4777-8777-777777777701', 'fc-archive-701', 'sophie.bernard@test.fr', 'Bernard', 'Sophie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777702', 'fc-archive-702', 'lucas.moreau@test.fr', 'Moreau', 'Lucas', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777703', 'fc-archive-703', 'camille.petit@test.fr', 'Petit', 'Camille', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777704', 'fc-archive-704', 'thomas.roux@test.fr', 'Roux', 'Thomas', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777705', 'fc-archive-705', 'julie.fournier@test.fr', 'Fournier', 'Julie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777706', 'fc-archive-706', 'nicolas.girard@test.fr', 'Girard', 'Nicolas', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777707', 'fc-archive-707', 'emma.bonnet@test.fr', 'Bonnet', 'Emma', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777708', 'fc-archive-708', 'antoine.dupont@test.fr', 'Dupont', 'Antoine', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777709', 'fc-archive-709', 'lea.lambert@test.fr', 'Lambert', 'Léa', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777710', 'fc-archive-710', 'maxime.fontaine@test.fr', 'Fontaine', 'Maxime', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777711', 'fc-archive-711', 'chloe.mercier@test.fr', 'Mercier', 'Chloé', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777712', 'fc-archive-712', 'hugo.rousseau@test.fr', 'Rousseau', 'Hugo', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777713', 'fc-archive-713', 'manon.vincent@test.fr', 'Vincent', 'Manon', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777714', 'fc-archive-714', 'paul.lefevre@test.fr', 'Lefèvre', 'Paul', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777715', 'fc-archive-715', 'ines.muller@test.fr', 'Muller', 'Inès', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777716', 'fc-archive-716', 'alexandre.simon@test.fr', 'Simon', 'Alexandre', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777717', 'fc-archive-717', 'clara.laurent@test.fr', 'Laurent', 'Clara', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777718', 'fc-archive-718', 'mathieu.leroy@test.fr', 'Leroy', 'Mathieu', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777719', 'fc-archive-719', 'alice.david@test.fr', 'David', 'Alice', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777720', 'fc-archive-720', 'romain.bertrand@test.fr', 'Bertrand', 'Romain', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777721', 'fc-archive-721', 'oceane.garnier@test.fr', 'Garnier', 'Océane', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777722', 'fc-archive-722', 'valentin.chevalier@test.fr', 'Chevalier', 'Valentin', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777723', 'fc-archive-723', 'sarah.nguyen@test.fr', 'Nguyen', 'Sarah', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777724', 'fc-archive-724', 'adrien.garcia@test.fr', 'Garcia', 'Adrien', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777725', 'fc-archive-725', 'lucie.martinez@test.fr', 'Martinez', 'Lucie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777726', 'fc-archive-726', 'benjamin.lopez@test.fr', 'Lopez', 'Benjamin', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777727', 'fc-archive-727', 'marine.hernandez@test.fr', 'Hernandez', 'Marine', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777728', 'fc-archive-728', 'florian.blanc@test.fr', 'Blanc', 'Florian', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777729', 'fc-archive-729', 'charlotte.guerin@test.fr', 'Guérin', 'Charlotte', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777730', 'fc-archive-730', 'quentin.boyer@test.fr', 'Boyer', 'Quentin', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777731', 'fc-archive-731', 'jean-eudes.dugenoux@test.fr', 'Dugenoux', 'Jean-Eudes', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777732', 'fc-archive-732', 'marie.lefebvre@test.fr', 'Lefebvre', 'Marie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777733', 'fc-archive-733', 'pierre.martin@test.fr', 'Martin', 'Pierre', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777734', 'fc-archive-734', 'nathalie.robin@test.fr', 'Robin', 'Nathalie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777735', 'fc-archive-735', 'jerome.faure@test.fr', 'Faure', 'Jérôme', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777736', 'fc-archive-736', 'stephanie.henry@test.fr', 'Henry', 'Stéphanie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777737', 'fc-archive-737', 'kevin.morel@test.fr', 'Morel', 'Kévin', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777738', 'fc-archive-738', 'aurelie.lemaire@test.fr', 'Lemaire', 'Aurélie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777739', 'fc-archive-739', 'sebastien.masson@test.fr', 'Masson', 'Sébastien', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777740', 'fc-archive-740', 'emilie.duval@test.fr', 'Duval', 'Émilie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777741', 'fc-archive-741', 'david.denis@test.fr', 'Denis', 'David', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777742', 'fc-archive-742', 'isabelle.lemoine@test.fr', 'Lemoine', 'Isabelle', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777743', 'fc-archive-743', 'christophe.durand@test.fr', 'Durand', 'Christophe', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777744', 'fc-archive-744', 'caroline.picard@test.fr', 'Picard', 'Caroline', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777745', 'fc-archive-745', 'mathias.clement@test.fr', 'Clément', 'Mathias', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777746', 'fc-archive-746', 'virginie.perrin@test.fr', 'Perrin', 'Virginie', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777747', 'fc-archive-747', 'franck.renard@test.fr', 'Renard', 'Franck', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777748', 'fc-archive-748', 'audrey.noel@test.fr', 'Noël', 'Audrey', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777749', 'fc-archive-749', 'guillaume.adam@test.fr', 'Adam', 'Guillaume', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777750', 'fc-archive-750', 'sandrine.riviere@test.fr', 'Rivière', 'Sandrine', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777751', 'fc-archive-751', 'yann.marchand@test.fr', 'Marchand', 'Yann', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777752', 'fc-archive-752', 'delphine.colin@test.fr', 'Colin', 'Delphine', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777753', 'fc-archive-753', 'fabien.vidal@test.fr', 'Vidal', 'Fabien', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777754', 'fc-archive-754', 'laetitia.brun@test.fr', 'Brun', 'Laëtitia', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777755', 'fc-archive-755', 'philippe.caron@test.fr', 'Caron', 'Philippe', NOW() - INTERVAL '90 days'),
  ('77777777-7777-4777-8777-777777777756', 'fc-archive-756', 'mylene.gaillard@test.fr', 'Gaillard', 'Mylène', NOW() - INTERVAL '90 days')
...
VALUES
  ...
  ('88888888-8888-8888-8888-888888888801', '77777777-7777-4777-8777-777777777701', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888802', '77777777-7777-4777-8777-777777777702', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888803', '77777777-7777-4777-8777-777777777703', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888804', '77777777-7777-4777-8777-777777777704', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888805', '77777777-7777-4777-8777-777777777705', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888806', '77777777-7777-4777-8777-777777777706', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888807', '77777777-7777-4777-8777-777777777707', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888808', '77777777-7777-4777-8777-777777777708', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888809', '77777777-7777-4777-8777-777777777709', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888810', '77777777-7777-4777-8777-777777777710', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888811', '77777777-7777-4777-8777-777777777711', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888812', '77777777-7777-4777-8777-777777777712', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888813', '77777777-7777-4777-8777-777777777713', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888814', '77777777-7777-4777-8777-777777777714', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888815', '77777777-7777-4777-8777-777777777715', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888816', '77777777-7777-4777-8777-777777777716', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888817', '77777777-7777-4777-8777-777777777717', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888818', '77777777-7777-4777-8777-777777777718', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888819', '77777777-7777-4777-8777-777777777719', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888820', '77777777-7777-4777-8777-777777777720', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888821', '77777777-7777-4777-8777-777777777721', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888822', '77777777-7777-4777-8777-777777777722', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888823', '77777777-7777-4777-8777-777777777723', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888824', '77777777-7777-4777-8777-777777777724', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888825', '77777777-7777-4777-8777-777777777725', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888826', '77777777-7777-4777-8777-777777777726', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888827', '77777777-7777-4777-8777-777777777727', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888828', '77777777-7777-4777-8777-777777777728', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888829', '77777777-7777-4777-8777-777777777729', 'choix_amo', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888830', '77777777-7777-4777-8777-777777777730', 'choix_amo', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888831', '77777777-7777-4777-8777-777777777731', 'factures', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888832', '77777777-7777-4777-8777-777777777732', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888833', '77777777-7777-4777-8777-777777777733', 'diagnostic', 'todo',
...
VALUES
  ...
  ('88888888-8888-8888-8888-888888888834', '77777777-7777-4777-8777-777777777734', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888835', '77777777-7777-4777-8777-777777777735', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888836', '77777777-7777-4777-8777-777777777736', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888837', '77777777-7777-4777-8777-777777777737', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888838', '77777777-7777-4777-8777-777777777738', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888839', '77777777-7777-4777-8777-777777777739', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888840', '77777777-7777-4777-8777-777777777740', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888841', '77777777-7777-4777-8777-777777777741', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888842', '77777777-7777-4777-8777-777777777742', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888843', '77777777-7777-4777-8777-777777777743', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888844', '77777777-7777-4777-8777-777777777744', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888845', '77777777-7777-4777-8777-777777777745', 'eligibilite', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888846', '77777777-7777-4777-8777-777777777746', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888847', '77777777-7777-4777-8777-777777777747', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888848', '77777777-7777-4777-8777-777777777748', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888849', '77777777-7777-4777-8777-777777777749', 'devis', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888850', '77777777-7777-4777-8777-777777777750', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888851', '77777777-7777-4777-8777-777777777751', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888852', '77777777-7777-4777-8777-777777777752', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888853', '77777777-7777-4777-8777-777777777753', 'diagnostic', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888854', '77777777-7777-4777-8777-777777777754', 'choix_amo', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888855', '77777777-7777-4777-8777-777777777755', 'choix_amo', 'todo',
  ...
  ('88888888-8888-8888-8888-888888888856', '77777777-7777-4777-8777-777777777756', 'factures', 'todo',
...
UPDATE parcours_prevention SET archived_by = 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001'
WHERE id IN (
...
VALUES
  ...
  ('99999999-9999-4999-8999-999999999903', '88888888-8888-8888-8888-888888888803', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '23 days'),

  ('99999999-9999-4999-8999-999999999904', '88888888-8888-8888-8888-888888888804', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique', 'email_envoye'], ARRAY['pas_zone_alea_fort'], NOW() - INTERVAL '21 days'),

  ('99999999-9999-4999-8999-999999999905', '88888888-8888-8888-8888-888888888805', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee', 'locataire_non_occupant'], NOW() - INTERVAL '19 days'),

  ('99999999-9999-4999-8999-999999999906', '88888888-8888-8888-8888-888888888806', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['nombre_etages_sup_2'], NOW() - INTERVAL '17 days'),

  ('99999999-9999-4999-8999-999999999907', '88888888-8888-8888-8888-888888888807', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '15 days'),

  ('99999999-9999-4999-8999-999999999908', '88888888-8888-8888-8888-888888888808', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['appartement'], NOW() - INTERVAL '13 days'),

  ('99999999-9999-4999-8999-999999999909', '88888888-8888-8888-8888-888888888809', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee', 'nombre_etages_sup_2'], NOW() - INTERVAL '11 days'),

  ('99999999-9999-4999-8999-999999999910', '88888888-8888-8888-8888-888888888810', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['email_envoye'], ARRAY['pas_zone_alea_fort', 'hors_zone_perimetre'], NOW() - INTERVAL '9 days'),

  ('99999999-9999-4999-8999-999999999911', '88888888-8888-8888-8888-888888888811', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '7 days'),

  ('99999999-9999-4999-8999-999999999912', '88888888-8888-8888-8888-888888888812', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee', 'nombre_etages_sup_2'], NOW() - INTERVAL '6 days'),

  ('99999999-9999-4999-8999-999999999913', '88888888-8888-8888-8888-888888888813', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['locataire_non_occupant'], NOW() - INTERVAL '5 days'),

  ('99999999-9999-4999-8999-999999999914', '88888888-8888-8888-8888-888888888814', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '4 days'),

  ('99999999-9999-4999-8999-999999999915', '88888888-8888-8888-8888-888888888815', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['pas_zone_alea_fort', 'maison_trop_endommagee'], NOW() - INTERVAL '3 days'),

  ('99999999-9999-4999-8999-999999999916', '88888888-8888-8888-8888-888888888816', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['nombre_etages_sup_2', 'hors_zone_perimetre'], NOW() - INTERVAL '2 days'),

  ('99999999-9999-4999-8999-999999999917', '88888888-8888-8888-8888-888888888817', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee', 'locataire_non_occupant'], NOW() - INTERVAL '2 days'),

  ('99999999-9999-4999-8999-999999999918', '88888888-8888-8888-8888-888888888818', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['email_envoye'], ARRAY['appartement', 'maison_moins_15_ans'], NOW() - INTERVAL '2 days'),

  -- === Période précédente (parcours 34-45) ===
  ('99999999-9999-4999-8999-999999999934', '88888888-8888-8888-8888-888888888834', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '56 days'),

  ('99999999-9999-4999-8999-999999999935', '88888888-8888-8888-8888-888888888835', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee', 'nombre_etages_sup_2'], NOW() - INTERVAL '54 days'),

  ('99999999-9999-4999-8999-999999999936', '88888888-8888-8888-8888-888888888836', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['pas_zone_alea_fort'], NOW() - INTERVAL '51 days'),

  ('99999999-9999-4999-8999-999999999937', '88888888-8888-8888-8888-888888888837', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '49 days'),

  ('99999999-9999-4999-8999-999999999938', '88888888-8888-8888-8888-888888888838', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee', 'locataire_non_occupant'], NOW() - INTERVAL '46 days'),

  ('99999999-9999-4999-8999-999999999939', '88888888-8888-8888-8888-888888888839', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['email_envoye'], ARRAY['nombre_etages_sup_2'], NOW() - INTERVAL '43 days'),

  ('99999999-9999-4999-8999-999999999940', '88888888-8888-8888-8888-888888888840', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '41 days'),

  ('99999999-9999-4999-8999-999999999941', '88888888-8888-8888-8888-888888888841', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['maison_trop_endommagee', 'pas_zone_alea_fort'], NOW() - INTERVAL '39 days'),

  ('99999999-9999-4999-8999-999999999942', '88888888-8888-8888-8888-888888888842', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee'], NOW() - INTERVAL '37 days'),

  ('99999999-9999-4999-8999-999999999943', '88888888-8888-8888-8888-888888888843', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['visite_domicile'], ARRAY['pas_zone_alea_fort'], NOW() - INTERVAL '35 days'),

  ('99999999-9999-4999-8999-999999999944', '88888888-8888-8888-8888-888888888844', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
   ARRAY['appel_telephonique'], ARRAY['maison_trop_endommagee', 'nombre_etages_sup_2'], NOW() - INTERVAL '33 days'),

  ('99999999-9999-4999-8999-999999999945', '88888888-8888-8888-8888-888888888845', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001', 'non_eligible',
...
WHERE pq.id::text LIKE '99999999-9999-4999-8999-%'
