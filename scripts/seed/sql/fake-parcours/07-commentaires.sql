  ...
  FROM (VALUES
    ...
    ('77777777-7777-4777-8777-777777777701'::uuid, '22222222-2222-4222-8222-222222222201'::uuid, 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001'::uuid,
    ...
    ('77777777-7777-4777-8777-777777777702', '22222222-2222-4222-8222-222222222201', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    ...
    ('77777777-7777-4777-8777-777777777703', '22222222-2222-4222-8222-222222222202', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777704', '22222222-2222-4222-8222-222222222202', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777705', '22222222-2222-4222-8222-222222222203', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777706', '22222222-2222-4222-8222-222222222204', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777707', '22222222-2222-4222-8222-222222222204', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777708', '22222222-2222-4222-8222-222222222205', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777709', '22222222-2222-4222-8222-222222222205', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777710', '22222222-2222-4222-8222-222222222231', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777711', '22222222-2222-4222-8222-222222222232', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
  ...
  -- =============================================================================
    ...
    ('77777777-7777-4777-8777-777777777712', '55555555-5555-4555-8555-555555555501', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777713', '55555555-5555-4555-8555-555555555501', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    -- Prospect 02 - Déols
    ('77777777-7777-4777-8777-777777777714', '55555555-5555-4555-8555-555555555502', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777715', '55555555-5555-4555-8555-555555555503', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777716', '55555555-5555-4555-8555-555555555503', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    ('77777777-7777-4777-8777-777777777717', '55555555-5555-4555-8555-555555555504', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    -- Prospect 05
    ('77777777-7777-4777-8777-777777777718', '55555555-5555-4555-8555-555555555505', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
    ...
    ('77777777-7777-4777-8777-777777777719', '55555555-5555-4555-8555-555555555505', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa002',
    'Jean-Patrick Duval', 'Allers-Vers Centre Indre', 'ALLERS_VERS',
    ...
    -- Prospect 06
    ('77777777-7777-4777-8777-777777777720', '55555555-5555-4555-8555-555555555506', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa001',
    'Géraldine Moulin', 'AMO du Berry Profond', 'AMO',
  ...
  SELECT 'Actions créées :' as info, count(*) as total FROM parcours_actions WHERE id::text LIKE '77777777-7777-4777-8777-7777777777%';
