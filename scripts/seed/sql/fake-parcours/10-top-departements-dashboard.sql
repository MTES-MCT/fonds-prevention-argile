...
-- UUID pattern : 99999999-9999-4999-8999-9999999999XX (users)
...
VALUES
  -- Allier (03) - 20 users
  ('99999999-9999-4999-8999-999999999901', 'fc-dept-901', 'pierre.allier01@test.fr', 'Dupuis', 'Pierre', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999902', 'fc-dept-902', 'marie.allier02@test.fr', 'Blanc', 'Marie', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999903', 'fc-dept-903', 'jean.allier03@test.fr', 'Perrot', 'Jean', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999904', 'fc-dept-904', 'sophie.allier04@test.fr', 'Roche', 'Sophie', NOW() - INTERVAL '22 days'),
  ('99999999-9999-4999-8999-999999999905', 'fc-dept-905', 'laurent.allier05@test.fr', 'Moulin', 'Laurent', NOW() - INTERVAL '21 days'),
  ('99999999-9999-4999-8999-999999999906', 'fc-dept-906', 'nathalie.allier06@test.fr', 'Gauthier', 'Nathalie', NOW() - INTERVAL '20 days'),
  ('99999999-9999-4999-8999-999999999907', 'fc-dept-907', 'philippe.allier07@test.fr', 'Besse', 'Philippe', NOW() - INTERVAL '19 days'),
  ('99999999-9999-4999-8999-999999999908', 'fc-dept-908', 'sylvie.allier08@test.fr', 'Fabre', 'Sylvie', NOW() - INTERVAL '18 days'),
  ('99999999-9999-4999-8999-999999999909', 'fc-dept-909', 'michel.allier09@test.fr', 'Cros', 'Michel', NOW() - INTERVAL '17 days'),
  ('99999999-9999-4999-8999-999999999910', 'fc-dept-910', 'valerie.allier10@test.fr', 'Vacher', 'Valérie', NOW() - INTERVAL '16 days'),
  ('99999999-9999-4999-8999-999999999911', 'fc-dept-911', 'alain.allier11@test.fr', 'Arnaud', 'Alain', NOW() - INTERVAL '15 days'),
  ('99999999-9999-4999-8999-999999999912', 'fc-dept-912', 'catherine.allier12@test.fr', 'Bonhomme', 'Catherine', NOW() - INTERVAL '14 days'),
  ('99999999-9999-4999-8999-999999999913', 'fc-dept-913', 'eric.allier13@test.fr', 'Chapuis', 'Éric', NOW() - INTERVAL '13 days'),
  ('99999999-9999-4999-8999-999999999914', 'fc-dept-914', 'isabelle.allier14@test.fr', 'Dumas', 'Isabelle', NOW() - INTERVAL '12 days'),
  ('99999999-9999-4999-8999-999999999915', 'fc-dept-915', 'didier.allier15@test.fr', 'Fournier', 'Didier', NOW() - INTERVAL '11 days'),
  ('99999999-9999-4999-8999-999999999916', 'fc-dept-916', 'florence.allier16@test.fr', 'Guillot', 'Florence', NOW() - INTERVAL '10 days'),
  ('99999999-9999-4999-8999-999999999917', 'fc-dept-917', 'franck.allier17@test.fr', 'Herve', 'Franck', NOW() - INTERVAL '9 days'),
  ('99999999-9999-4999-8999-999999999918', 'fc-dept-918', 'anne.allier18@test.fr', 'Imbert', 'Anne', NOW() - INTERVAL '8 days'),
  ('99999999-9999-4999-8999-999999999919', 'fc-dept-919', 'bruno.allier19@test.fr', 'Jourdain', 'Bruno', NOW() - INTERVAL '7 days'),
  ('99999999-9999-4999-8999-999999999920', 'fc-dept-920', 'colette.allier20@test.fr', 'Lacroix', 'Colette', NOW() - INTERVAL '6 days'),
  -- Dordogne (24) - 12 users
  ('99999999-9999-4999-8999-999999999921', 'fc-dept-921', 'marc.dordogne01@test.fr', 'Peyroux', 'Marc', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999922', 'fc-dept-922', 'dominique.dordogne02@test.fr', 'Lascaux', 'Dominique', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999923', 'fc-dept-923', 'patrick.dordogne03@test.fr', 'Bergerat', 'Patrick', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999924', 'fc-dept-924', 'monique.dordogne04@test.fr', 'Sarlat', 'Monique', NOW() - INTERVAL '22 days'),
  ('99999999-9999-4999-8999-999999999925', 'fc-dept-925', 'daniel.dordogne05@test.fr', 'Montpon', 'Daniel', NOW() - INTERVAL '21 days'),
  ('99999999-9999-4999-8999-999999999926', 'fc-dept-926', 'helene.dordogne06@test.fr', 'Razac', 'Hélène', NOW() - INTERVAL '20 days'),
  ('99999999-9999-4999-8999-999999999927', 'fc-dept-927', 'thierry.dordogne07@test.fr', 'Villamblard', 'Thierry', NOW() - INTERVAL '19 days'),
  ('99999999-9999-4999-8999-999999999928', 'fc-dept-928', 'veronique.dordogne08@test.fr', 'Castels', 'Véronique', NOW() - INTERVAL '18 days'),
  ('99999999-9999-4999-8999-999999999929', 'fc-dept-929', 'claude.dordogne09@test.fr', 'Excideuil', 'Claude', NOW() - INTERVAL '17 days'),
  ('99999999-9999-4999-8999-999999999930', 'fc-dept-930', 'martine.dordogne10@test.fr', 'Nontron', 'Martine', NOW() - INTERVAL '16 days'),
  ('99999999-9999-4999-8999-999999999931', 'fc-dept-931', 'yves.dordogne11@test.fr', 'Terrasson', 'Yves', NOW() - INTERVAL '15 days'),
  ('99999999-9999-4999-8999-999999999932', 'fc-dept-932', 'corinne.dordogne12@test.fr', 'Daglan', 'Corinne', NOW() - INTERVAL '14 days'),
  -- Gers (32) - 8 users
  ('99999999-9999-4999-8999-999999999933', 'fc-dept-933', 'rene.gers01@test.fr', 'Armagnac', 'René', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999934', 'fc-dept-934', 'mireille.gers02@test.fr', 'Lectoure', 'Mireille', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999935', 'fc-dept-935', 'henri.gers03@test.fr', 'Condom', 'Henri', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999936', 'fc-dept-936', 'josette.gers04@test.fr', 'Fleurance', 'Josette', NOW() - INTERVAL '22 days'),
  ('99999999-9999-4999-8999-999999999937', 'fc-dept-937', 'gerard.gers05@test.fr', 'Mirande', 'Gérard', NOW() - INTERVAL '21 days'),
  ('99999999-9999-4999-8999-999999999938', 'fc-dept-938', 'arlette.gers06@test.fr', 'Lombez', 'Arlette', NOW() - INTERVAL '20 days'),
  ('99999999-9999-4999-8999-999999999939', 'fc-dept-939', 'robert.gers07@test.fr', 'Gimont', 'Robert', NOW() - INTERVAL '19 days'),
  ('99999999-9999-4999-8999-999999999940', 'fc-dept-940', 'paulette.gers08@test.fr', 'Samatan', 'Paulette', NOW() - INTERVAL '18 days'),
  -- Lot-et-Garonne (47) - 6 users
  ('99999999-9999-4999-8999-999999999941', 'fc-dept-941', 'jacques.lot01@test.fr', 'Agen', 'Jacques', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999942', 'fc-dept-942', 'genevieve.lot02@test.fr', 'Marmande', 'Geneviève', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999943', 'fc-dept-943', 'andre.lot03@test.fr', 'Villeneuve', 'André', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999944', 'fc-dept-944', 'odette.lot04@test.fr', 'Tonneins', 'Odette', NOW() - INTERVAL '22 days'),
  ('99999999-9999-4999-8999-999999999945', 'fc-dept-945', 'raymond.lot05@test.fr', 'Nerac', 'Raymond', NOW() - INTERVAL '21 days'),
  ('99999999-9999-4999-8999-999999999946', 'fc-dept-946', 'lucienne.lot06@test.fr', 'Fumel', 'Lucienne', NOW() - INTERVAL '20 days'),
  -- Tarn (81) - 5 users
  ('99999999-9999-4999-8999-999999999947', 'fc-dept-947', 'bernard.tarn01@test.fr', 'Albi', 'Bernard', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999948', 'fc-dept-948', 'jeanne.tarn02@test.fr', 'Castres', 'Jeanne', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999949', 'fc-dept-949', 'maurice.tarn03@test.fr', 'Gaillac', 'Maurice', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999950', 'fc-dept-950', 'denise.tarn04@test.fr', 'Mazamet', 'Denise', NOW() - INTERVAL '22 days'),
  ('99999999-9999-4999-8999-999999999951', 'fc-dept-951', 'leon.tarn05@test.fr', 'Lavaur', 'Léon', NOW() - INTERVAL '21 days'),
  -- Tarn-et-Garonne (82) - 4 users
  ('99999999-9999-4999-8999-999999999952', 'fc-dept-952', 'fernand.teg01@test.fr', 'Montauban', 'Fernand', NOW() - INTERVAL '25 days'),
  ('99999999-9999-4999-8999-999999999953', 'fc-dept-953', 'yvette.teg02@test.fr', 'Moissac', 'Yvette', NOW() - INTERVAL '24 days'),
  ('99999999-9999-4999-8999-999999999954', 'fc-dept-954', 'gaston.teg03@test.fr', 'Castelsarrasin', 'Gaston', NOW() - INTERVAL '23 days'),
  ('99999999-9999-4999-8999-999999999955', 'fc-dept-955', 'germaine.teg04@test.fr', 'Caussade', 'Germaine', NOW() - INTERVAL '22 days')
...
VALUES
  -- 12 eligibles
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa901', '99999999-9999-4999-8999-999999999901', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa902', '99999999-9999-4999-8999-999999999902', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa903', '99999999-9999-4999-8999-999999999903', 'diagnostic', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa904', '99999999-9999-4999-8999-999999999904', 'diagnostic', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa905', '99999999-9999-4999-8999-999999999905', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa906', '99999999-9999-4999-8999-999999999906', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa907', '99999999-9999-4999-8999-999999999907', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa908', '99999999-9999-4999-8999-999999999908', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa909', '99999999-9999-4999-8999-999999999909', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa910', '99999999-9999-4999-8999-999999999910', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa911', '99999999-9999-4999-8999-999999999911', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa912', '99999999-9999-4999-8999-999999999912', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa913', '99999999-9999-4999-8999-999999999913', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa914', '99999999-9999-4999-8999-999999999914', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa915', '99999999-9999-4999-8999-999999999915', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa916', '99999999-9999-4999-8999-999999999916', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa917', '99999999-9999-4999-8999-999999999917', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa918', '99999999-9999-4999-8999-999999999918', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa919', '99999999-9999-4999-8999-999999999919', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa920', '99999999-9999-4999-8999-999999999920', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa921', '99999999-9999-4999-8999-999999999921', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa922', '99999999-9999-4999-8999-999999999922', 'diagnostic', 'todo',
   ...
   NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa923', '99999999-9999-4999-8999-999999999923', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa924', '99999999-9999-4999-8999-999999999924', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa925', '99999999-9999-4999-8999-999999999925', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '21 days', NOW() - INTERVAL '21 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa926', '99999999-9999-4999-8999-999999999926', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa927', '99999999-9999-4999-8999-999999999927', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '19 days', NOW() - INTERVAL '19 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa928', '99999999-9999-4999-8999-999999999928', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa929', '99999999-9999-4999-8999-999999999929', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '17 days', NOW() - INTERVAL '17 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa930', '99999999-9999-4999-8999-999999999930', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '16 days', NOW() - INTERVAL '16 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa931', '99999999-9999-4999-8999-999999999931', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa932', '99999999-9999-4999-8999-999999999932', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa933', '99999999-9999-4999-8999-999999999933', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa934', '99999999-9999-4999-8999-999999999934', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa935', '99999999-9999-4999-8999-999999999935', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa936', '99999999-9999-4999-8999-999999999936', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa937', '99999999-9999-4999-8999-999999999937', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '21 days', NOW() - INTERVAL '21 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa938', '99999999-9999-4999-8999-999999999938', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days'),
  -- 2 non eligibles
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa939', '99999999-9999-4999-8999-999999999939', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '19 days', NOW() - INTERVAL '19 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa940', '99999999-9999-4999-8999-999999999940', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa941', '99999999-9999-4999-8999-999999999941', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa942', '99999999-9999-4999-8999-999999999942', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa943', '99999999-9999-4999-8999-999999999943', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa944', '99999999-9999-4999-8999-999999999944', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days'),
  -- 2 non eligibles
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa945', '99999999-9999-4999-8999-999999999945', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '21 days', NOW() - INTERVAL '21 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa946', '99999999-9999-4999-8999-999999999946', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa947', '99999999-9999-4999-8999-999999999947', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa948', '99999999-9999-4999-8999-999999999948', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa949', '99999999-9999-4999-8999-999999999949', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa950', '99999999-9999-4999-8999-999999999950', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa951', '99999999-9999-4999-8999-999999999951', 'eligibilite', 'todo',
  ...
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa952', '99999999-9999-4999-8999-999999999952', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa953', '99999999-9999-4999-8999-999999999953', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days'),
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa954', '99999999-9999-4999-8999-999999999954', 'eligibilite', 'todo',
   ...
   NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days'),
  -- 1 non eligible
  ('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa955', '99999999-9999-4999-8999-999999999955', 'eligibilite', 'todo',
...
VALUES
  -- Allier
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb901', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa901', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb902', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa902', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb903', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa903', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb904', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa904', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '21 days', NOW() - INTERVAL '21 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb905', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa905', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb906', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa906', 'eligibilite', 'demarche-eligibilite', 'en_instruction', NOW() - INTERVAL '19 days', NOW() - INTERVAL '19 days', NOW()),
  -- Dordogne
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb907', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa921', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb908', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa922', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb909', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa923', 'eligibilite', 'demarche-eligibilite', 'en_instruction', NOW() - INTERVAL '22 days', NOW() - INTERVAL '22 days', NOW()),
  -- Gers
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb910', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa933', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb911', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa934', 'eligibilite', 'demarche-eligibilite', 'en_instruction', NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days', NOW()),
  -- Lot-et-Garonne
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb912', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa941', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  -- Tarn
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb913', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa947', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW()),
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb914', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa948', 'eligibilite', 'demarche-eligibilite', 'en_instruction', NOW() - INTERVAL '23 days', NOW() - INTERVAL '23 days', NOW()),
  -- Tarn-et-Garonne
  ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb915', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaa952', 'eligibilite', 'demarche-eligibilite', 'accepte', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days', NOW())
ON CONFLICT (id) DO NOTHING;
