 ...
 *   NO_DATE  DS ne renvoie pas de dateTraitement (dossier disparu / non traité) → ignoré
...
type Verdict = "FILL" | "CORRECT" | "OK" | "NO_DATE" | "ERREUR";
...
async function main() {
  ...
  try {
    ...
    console.log("=".repeat(72));
    console.log("RÉCAP");
    for (const v of ["FILL", "CORRECT", "OK", "NO_DATE", "ERREUR"] as Verdict[]) {
