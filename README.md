...
| `NEXT_PUBLIC_DEPARTEMENTS_AV_AMO_FUSIONNES` | CSV codes dept | _(vide)_         | Départements où l'aller-vers local est aussi l'AMO. N'implique pas l'obligation. Optionnel. |
...
- `NEXT_PUBLIC_DEPARTEMENTS_AV_AMO_FUSIONNES=32` (l'aller-vers du Gers est aussi l'AMO, sans l'imposer)
